...
class AuthTest extends TestCase
{
    ...
    //Мы используем setUp там где мы можем как то объединить начашльные настройки для наших тестов внутри одного класса. Для каждого из тестов этот setUp будет запущен //Для каждого класса будет свой setUp
